        ...
        public ReadOnlySequence<T> Slice(long start, long length)
        {
                ...
                else
                {
                    ...
                    else
                    {
                        if (endIndex - beginIndex < length)
                            throw new ArgumentOutOfRangeException(); // Passing value >= 0 means throw exception on length argument
            ...
            else
            {
                if (endIndex - startIndex < start)
                    throw new ArgumentOutOfRangeException(); // Passing value < 0 means throw exception on start argument
